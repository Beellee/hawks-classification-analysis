...
Como podemos observar k means no suele confundir los grupos de Sharp-Shinned (en amarillo en k means y verde en la clasificacion real) y Red-tailed (en morado en k means y rojo en la clasificacion real). Sin embargo tiende a confundir los individuos de la especie Cooper’s (azul en k means y negro en la clasificación real) con Red-tailed y Sharp-Shinned. 

Si retomamos las conclusiones que obtuvimos en el analisis preeliminar esta confusión tiene cierto sentido puesto que Sharp-Shinned tenia una embergadura pequeña, Red-tailed tenía una embergadura bastante grande y Cooper’s se encontraba en la media. 
...
- Cooper’s se han clasificado 32 individuos en el cluster 2 y 36 en el cluster 3.  
- Red-tailed se han clasificado 226 en el cluster 1 y 227 en el cluster 2.   
- Sharp-Shinned se han clasificado 191 individuos en el cluster 3 y 1 en el cluster 2.   


Podríamos decir que el cluster 1 corresponde a Red-tailed, el cluster 2 corresponde a Cooper’s y el cluster 3 corresponde a  Sharp-Shinned. Sin embargo para Cooper’s y Red-tailed las observaciones se distribuyen prácticamente a la mitad entre dos clusters. 

Así: 

- Cooper’s tiene un 46.26% de sus observaciones en el cluster 2 y un 53.73% de sus observaciones en el cluster 3.    
- Red-tailed tiene un 48.98% de sus observaciones en el cluster 1 y un 51.01% de sus observaciones en el cluster 2.      
- Sharp-Shinned tiene un 0.52% de sus observaciones en el cluster 2 y un 99.47% de sus observaciones en el cluster 3.  
...
Para nuestro caso de estudio, la aplicación de k-means y DBSCAN para el clustering de tres especies de halcones basado en sus atributos físicos ha arrojado resultados distintos y revelado características específicas de cada algoritmo.

**K-means:**

- K-means parece haber tenido dificultades para manejar la variabilidad y solapamiento entre las especies, especialmente evidente en la distribución casi equitativa de individuos de Cooper’s y Red-tailed entre dos clusters.

- La interpretación de los resultados de k-means sugiere una confusión significativa entre individuos más pequeños de Cooper’s y Sharp-Shinned, así como entre individuos más grandes de Cooper’s y Red-tailed.

- La sensibilidad a la forma esférica de los clusters y la dependencia de los valores iniciales de los centroides han contribuido a esta confusión.

**DBSCAN:**

- DBSCAN, por otro lado, ha demostrado ser más robusto en la identificación de clusters de forma variable y ha asignado correctamente un alto porcentaje de individuos a sus respectivos grupos.

- Sin embargo, DBSCAN también presenta algunas limitaciones, como la exclusión de un pequeño porcentaje de individuos que no pertenecen a ningún cluster.

**Comparación:**

Ambos algoritmos han mostrado una buena capacidad para identificar individuos de la especie Sharp-Shinned, pero k-means ha presentado dificultades con las especies Cooper’s y Red-tailed.

En el contexto específico de nuestro conjunto de datos, mi opinión es que DBSCAN es más efectivo al identificar clusters mas afines a la distribución de nuestros datos. Aunque k-means proporciona una clasificación visual más clara, no es de utilidad a la hora de diferenciar individuos de las especies de halcon en base a sus atributos físicos. Por otro lado, DBSCAN encuentra patrones más detallados y hace una mejor identificación de individuos de las especies de halcones analizadas.
